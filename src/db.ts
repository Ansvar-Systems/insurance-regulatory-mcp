/**
 * SQLite database access layer for the Insurance Regulatory Intelligence MCP server.
 *
 * Schema:
 *   - frameworks  — IAIS Insurance Core Principles, Application Papers, ComFrame, and supplementary frameworks
 *   - standards   — Individual ICPs and application paper entries within each framework
 *   - supplementary_standards — NAIC model laws and Lloyd's market requirements
 *
 * FTS5 virtual tables back full-text search on standards and supplementary standards.
 */
...
CREATE INDEX IF NOT EXISTS idx_frameworks_framework ON frameworks(framework);
